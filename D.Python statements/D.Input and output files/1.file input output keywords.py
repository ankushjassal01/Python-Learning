...
# seek(0).0 is for total reset. if want to see in id the put the length of 
...
# to open the file in the differnt location the its pwd
...
with open ('myfile.txt', mode='a') as A:
    A.write('\nwritten value above is thirty five')
   # print(A.read()) wont work with append files
